...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>squirt/bookmarklet.js at master · cameron/squirt · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars3.githubusercontent.com/u/149910?v=3&amp;s=400" property="og:image" /><meta content="cameron/squirt" property="og:title" /><meta content="https://github.com/cameron/squirt" property="og:url" /><meta content="squirt - Speed read the web." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="805209B6:12A9:1156C2F:54D90E22" name="octolytics-dimension-request_id" />
...
<meta content="/K2vDu3mQBHwfbaHHN6vgQ81tkXHWgzxO4oiy2HCaJAJoNOj+GzQ4fevIfbEe8tVdBVXTlYo5FOLI5IoPO4R7g==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="button" href="/login?return_to=%2Fcameron%2Fsquirt%2Fblob%2Fmaster%2Fbookmarklet.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/cameron/squirt/blob/660bbc41bb299d49a0460598eaa532d09db29f95/bookmarklet.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:100a220ed8c4baf71a9832cdb3e833f9 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              ...
              <a href="/cameron/squirt/blob/dev/bookmarklet.js"
                 data-name="dev"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/cameron/squirt/blob/master/bookmarklet.js"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
...
<include-fragment class="commit commit-loader file-history-tease" src="/cameron/squirt/contributors/master/bookmarklet.js">
...
<div class="file-box">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/cameron/squirt/raw/master/bookmarklet.js" class="minibutton " id="raw-url">Raw</a>
            <a href="/cameron/squirt/blame/master/bookmarklet.js" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/cameron/squirt/commits/master/bookmarklet.js" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
  ...
  <div class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code js-file-line">  <span class="pl-k">if</span>(<span class="pl-s3">window</span>.sq){</td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code js-file-line">     <span class="pl-s3">window</span>.sq.<span class="pl-sc">closed</span> <span class="pl-k">&amp;&amp;</span> <span class="pl-s3">window</span>.<span class="pl-s3">document</span>.dispatchEvent(<span class="pl-k">new</span> <span class="pl-en">Event</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>squirt.again<span class="pl-pds">&#39;</span></span>));</td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code js-file-line">  } <span class="pl-k">else</span> {</td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code js-file-line">    <span class="pl-s3">window</span>.sq <span class="pl-k">=</span> {};</td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code js-file-line">    <span class="pl-s3">window</span>.sq.userId <span class="pl-k">=</span> <span class="pl-s1"><span class="pl-pds">&#39;</span>--squirtUser--<span class="pl-pds">&#39;</span></span>;</td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code js-file-line">    s <span class="pl-k">=</span> <span class="pl-s3">document</span>.<span class="pl-s3">createElement</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>script<span class="pl-pds">&#39;</span></span>);</td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code js-file-line">    s.<span class="pl-sc">src</span> <span class="pl-k">=</span> <span class="pl-s1"><span class="pl-pds">&#39;</span>http://www.squirt.io/bm/squirt.js<span class="pl-pds">&#39;</span></span>;</td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code js-file-line">    s.s <span class="pl-k">=</span> <span class="pl-s3">window</span>.<span class="pl-sc">location</span>.search;</td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code js-file-line">    s.idx <span class="pl-k">=</span> s.s.<span class="pl-s3">indexOf</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>sq-dev<span class="pl-pds">&#39;</span></span>);</td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code js-file-line">    <span class="pl-k">if</span>(s.idx <span class="pl-k">!=</span> <span class="pl-k">-</span><span class="pl-c1">1</span>){</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code js-file-line">      s.ampIdx <span class="pl-k">=</span> s.s.<span class="pl-s3">indexOf</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>&amp;<span class="pl-pds">&#39;</span></span>, s.idx);</td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code js-file-line">      s.<span class="pl-sc">host</span> <span class="pl-k">=</span> s.s.<span class="pl-s3">substring</span>(s.idx <span class="pl-k">+</span> <span class="pl-c1">7</span>, s.ampIdx <span class="pl-k">==</span> <span class="pl-k">-</span><span class="pl-c1">1</span> <span class="pl-k">?</span> s.s.<span class="pl-sc">length</span> <span class="pl-k">:</span> s.ampIdx);</td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code js-file-line">      s.<span class="pl-sc">src</span> <span class="pl-k">=</span> <span class="pl-s1"><span class="pl-pds">&#39;</span>http://<span class="pl-pds">&#39;</span></span> <span class="pl-k">+</span> (s.<span class="pl-sc">host</span> <span class="pl-k">?</span> s.<span class="pl-sc">host</span> <span class="pl-k">:</span> <span class="pl-s1"><span class="pl-pds">&#39;</span>localhost<span class="pl-pds">&#39;</span></span>) <span class="pl-k">+</span> <span class="pl-s1"><span class="pl-pds">&#39;</span>:4000/bm/squirt.js<span class="pl-pds">&#39;</span></span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC16" class="blob-code js-file-line">    <span class="pl-s3">document</span>.<span class="pl-sc">body</span>.<span class="pl-s3">appendChild</span>(s);</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04018s from github-fe124-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
